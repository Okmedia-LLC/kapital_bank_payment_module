<?php
namespace Opencart\Admin\Model\Extension\KapitalBank\Payment;
class KapitalBank extends \Opencart\System\Engine\Model {

    public function install(): void {
        $this->db->query("
			CREATE TABLE IF NOT EXISTS`" . DB_PREFIX . "kapital_bank_order` (
		...
		");
        $this->db->query("
			CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "kapital_bank_refunds` (
				`id` INT(11) NOT NULL AUTO_INCREMENT,
				`order_id` int(11) NOT NULL,
